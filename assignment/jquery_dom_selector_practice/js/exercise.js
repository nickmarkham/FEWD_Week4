 ...
 */
    ...
    // description: The .attr() method gets the attribute value for only the first element in the matched set.
      // 1. Trigger on click of button3
      // 2. Source all classes in html labelled as .city
      // 3. Visit lorempixel.com and retrieve only first image on page. Ignore any other images present on server.
      // 4. Replace orignal .city img with new img from lorempixel.com.
